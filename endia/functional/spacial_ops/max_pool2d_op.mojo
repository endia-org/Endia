...
struct MaxPool2d:
    ...
    fn fwd(
        ...
        if arg0.is_complex():
            raise "Complex numbers are not supported for max_pool2d!"
...
fn max_pool2d(
    ...
    Args:
        ...
        stride: The stride of the window. Default is (1, 1).
        padding: The padding to apply to the input tensor. Default is (0, 0).
        dilation: The dilation to apply to the input tensor. Default is (1, 1).
