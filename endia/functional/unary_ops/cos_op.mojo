...
struct Cos(DifferentiableUnaryOp):
    @staticmethod
    fn fwd(arg0: Array) raises -> Array:
        ...
        return unary_op_array(
            arg0, "cos", Cos.__call__, Cos.jvp, Cos.vjp, Cos.unary_simd_op
        )
    ...
    fn jvp(primals: List[Array], tangents: List[Array]) raises -> Array:
        ...
        """
        return -sin(primals[0]) * tangents[0]
    ...
    fn unary_simd_op(
        ...
        """
        var real = math.cos(arg0_real) * math.cosh(arg0_imag)
        var imag = -math.sin(arg0_real) * math.sinh(arg0_imag)
        return real, imag
...
fn cos(arg0: Array) raises -> Array:
    """Computes the cosine of the input array element-wise.
