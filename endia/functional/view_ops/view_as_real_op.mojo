...
struct ViewAsReal(DifferentiableViewOp):
    @staticmethod
    fn compute_shape(inout curr: ArrayShape, args: List[ArrayShape]) raises:
        ...
        Args:
            ...
            args: The ArrayShape to view as the real part.
        """
    ...
    fn __call__(inout curr: Array, args: List[Array]) raises:
        ...
        Args:
            ...
            args: The array on which the view_as_real view is created.
...
fn view_as_real(arg0: Array) raises -> Array:
    """
